...
{
    public class FooterAdminRepository
    {
        private FonNatureDbContext _db = null;

        public FonNatureDbContext Db { get => _db; set => _db = value; }

        private static FooterAdminRepository instance = new FooterAdminRepository();

        private FooterAdminRepository()
        {
            _db = new FonNatureDbContext();
        }

        public static FooterAdminRepository getInstance()
        {
            return instance;
        }
