            ...
            $.ajax({
                ...
                success: function (res) {
                    ...
                    if (res.product != null) {
                        ...
                        var htmlString = `<tr><td class="pro-thumbnail"><a href="#"><img src="${res.product.image}" alt="Product"></a></td><td class="pro-title"><a href="#">${res.product.name}</a></td><td class="pro-price"><span>$${price}</span></td><td class="pro-quantity"><div class="pro-qty"><input min="1" max="9999" type="number" value="${value.quantity}"></div></td><td class="pro-subtotal"><span>$${totalAmount}</span></td><td class="pro-remove_${res.product.id}"><a href="#"><i class="fa fa-trash-o"></i></a></td></tr>`;
